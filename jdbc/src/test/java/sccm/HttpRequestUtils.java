...
public class HttpRequestUtils {
     ...
     * @throws UnsupportedEncodingException
     */
    public static String httpPost(String url, JSONObject headers, Object params, Integer timeOut, boolean isStream, HttpClientContext clientContext) throws UnsupportedEncodingException {
        // 创建post请求
        HttpPost httpPost = new HttpPost(url);
        // 设置请求头 发送的是json数据格式
